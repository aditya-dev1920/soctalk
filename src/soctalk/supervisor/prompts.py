...
- **CONTEXTUALIZE (Orient: Strategic Attribution)**:
  ...
  - **⛔ Disabled Server Guardrail:** If MISP is disabled, unconfigured, or returns `NoneType`/client errors, **NEVER select CONTEXTUALIZE**. Route directly to `INVESTIGATE` or `VERDICT`.
